...
let exercises: [ExerciseData] = [
    ...
    ExerciseData(name: "Snatch Grip High Pull", muscles: ["Traps": 3, "Shoulders": 2, "Glutes": 2, "Quads": 2, "Hamstrings": 1]),
    ExerciseData(name: "Farmer’s Carry", muscles: ["Forearms": 3, "Traps": 2, "Abs": 2]),
    ...
    ExerciseData(name: "Straight Arm Pulldown", muscles: ["Lats": 3, "Triceps": 1, "Abs": 1]),
    ExerciseData(name: "Single Arm Lat Pulldown", muscles: ["Lats": 3, "Biceps": 2, "Rear Delts": 1, "Abs": 1]),
    ExerciseData(name: "Resistance Band Pulldown", muscles: ["Lats": 3, "Biceps": 2]),

    /* CHEST */
    ExerciseData(name: "Barbell Bench Press", muscles: ["Chest": 3, "Triceps": 2, "Shoulders": 2]),
    ...
    ExerciseData(name: "Dumbbell Bench Press", muscles: ["Chest": 3, "Triceps": 2, "Shoulders": 2]),
    ...
    ExerciseData(name: "Push-Up", muscles: ["Chest": 3, "Triceps": 2, "Shoulders": 2, "Abs": 1]),
    ...
    /* SHOULDERS */
    ExerciseData(name: "Overhead Press", muscles: ["Shoulders": 3, "Triceps": 2, "Abs": 1]),
    ExerciseData(name: "Dumbbell Shoulder Press", muscles: ["Shoulders": 3, "Triceps": 2, "Abs": 1]),
    ExerciseData(name: "Arnold Press", muscles: ["Shoulders": 3, "Triceps": 1]),
    ...
    ExerciseData(name: "Front Raise", muscles: ["Shoulders": 2, "Chest": 1]),
    ExerciseData(name: "Plate Raise", muscles: ["Shoulders": 2, "Chest": 1]),
    ExerciseData(name: "Upright Row", muscles: ["Traps": 3, "Shoulders": 2, "Biceps": 1]),
    ...
    ExerciseData(name: "Hammer Curl", muscles: ["Biceps": 2, "Forearms": 2]),
    ...
    ExerciseData(name: "Zottman Curl", muscles: ["Biceps": 2, "Forearms": 3]),
    ExerciseData(name: "Reverse Curl", muscles: ["Forearms": 3, "Biceps": 1]),
    ...
    ExerciseData(name: "Close Grip Bench Press", muscles: ["Triceps": 3, "Chest": 2, "Shoulders": 1]),
    ExerciseData(name: "Bench Dips", muscles: ["Triceps": 3, "Chest": 2, "Shoulders": 1]),
    ExerciseData(name: "Close Grip Push-Up", muscles: ["Triceps": 3, "Chest": 2, "Shoulders": 1, "Abs": 1]),

    /* FOREARMS */
    ExerciseData(name: "Wrist Curl", muscles: ["Forearms": 3]),
    ExerciseData(name: "Reverse Wrist Curl", muscles: ["Forearms": 3]),
    ExerciseData(name: "Dead Hang", muscles: ["Forearms": 3, "Lats": 1, "Traps": 1, "Abs": 1]),
    ExerciseData(name: "Towel Hang", muscles: ["Forearms": 3, "Biceps": 1, "Lats": 1, "Abs": 1]),

    /* CORE */
    ExerciseData(name: "Crunch", muscles: ["Abs": 3]),
    ExerciseData(name: "Sit-Up", muscles: ["Abs": 3, "Quads": 1]),
    ExerciseData(name: "Decline Sit-Up", muscles: ["Abs": 3, "Quads": 1]),
    ExerciseData(name: "Hanging Leg Raise", muscles: ["Abs": 3, "Quads": 2, "Forearms": 1]),
    ExerciseData(name: "Hanging Knee Raise", muscles: ["Abs": 3, "Quads": 2, "Forearms": 1]),
    ExerciseData(name: "Ab Rollout", muscles: ["Abs": 3, "Shoulders": 2, "Lats": 1]),
    ExerciseData(name: "Plank", muscles: ["Abs": 3, "Glutes": 2, "Shoulders": 1]),
    ...
    ExerciseData(name: "Bicycle Crunch", muscles: ["Abs": 3, "Obliques": 2, "Quads": 1]),
    ExerciseData(name: "Flutter Kicks", muscles: ["Abs": 3, "Quads": 2]),
    ExerciseData(name: "Mountain Climbers", muscles: ["Abs": 3, "Shoulders": 2, "Quads": 1]),
    ...
    ExerciseData(name: "Sumo Squat", muscles: ["Quads": 2, "Glutes": 2, "Adductors": 2, "Hamstrings": 1]),
    ExerciseData(name: "Side Lunge", muscles: ["Quads": 2, "Adductors": 2, "Glutes": 1]),
    ExerciseData(name: "Curtsy Lunge", muscles: ["Glutes": 2, "Adductors": 2, "Quads": 1]),

    /* ABDUCTORS */
    ExerciseData(name: "Hip Abduction Machine", muscles: ["Abductors": 3, "Glutes": 2]),
    ExerciseData(name: "Cable Hip Abduction", muscles: ["Abductors": 3, "Glutes": 2]),
    ExerciseData(name: "Band Walk", muscles: ["Abductors": 3, "Glutes": 2]),
    ExerciseData(name: "Clamshell", muscles: ["Abductors": 3, "Glutes": 2]),

    /* GLUTES */
    ExerciseData(name: "Hip Thrust", muscles: ["Glutes": 3, "Hamstrings": 2]),
    ExerciseData(name: "Barbell Hip Thrust", muscles: ["Glutes": 3, "Hamstrings": 2]),
    ExerciseData(name: "Glute Bridge", muscles: ["Glutes": 3, "Hamstrings": 2]),
    ExerciseData(name: "Cable Kickback", muscles: ["Glutes": 3, "Hamstrings": 1]),
    ExerciseData(name: "Step-Up", muscles: ["Quads": 2, "Glutes": 2, "Calves": 1]),
    ExerciseData(name: "Reverse Lunge", muscles: ["Glutes": 2, "Hamstrings": 2, "Quads": 1]),
    ExerciseData(name: "Frog Pump", muscles: ["Glutes": 3, "Adductors": 2]),

    /* HAMSTRINGS */
    ExerciseData(name: "Romanian Deadlift", muscles: ["Hamstrings": 3, "Glutes": 2, "Abs": 1, "Forearms": 1]),
    ExerciseData(name: "Stiff Leg Deadlift", muscles: ["Hamstrings": 3, "Glutes": 2, "Abs": 1, "Forearms": 1]),
    ExerciseData(name: "Leg Curl", muscles: ["Hamstrings": 3]),
    ExerciseData(name: "Seated Leg Curl", muscles: ["Hamstrings": 3]),
    ExerciseData(name: "Nordic Curl", muscles: ["Hamstrings": 3, "Glutes": 1]),
    ExerciseData(name: "Good Morning", muscles: ["Hamstrings": 3, "Glutes": 2, "Abs": 1]),

    /* QUADS */
    ExerciseData(name: "Back Squat", muscles: ["Quads": 3, "Glutes": 2, "Hamstrings": 1, "Abs": 2]),
    ExerciseData(name: "Front Squat", muscles: ["Quads": 3, "Glutes": 1, "Abs": 2]),
    ...
    ExerciseData(name: "Toe Walk", muscles: ["Calves": 3, "Abs": 1])
]
